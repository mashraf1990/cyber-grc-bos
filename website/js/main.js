...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const i18n = {
    en: {
      ...
      heroBadge: 'Cybersecurity \u00b7 Governance \u00b7 Risk \u00b7 Compliance',
      ...
      trustedBy: 'Consulting Experience Across the Middle East and North America',
    ...
    ar: {
      ...
      heroBadge: 'الأمن السيبراني · الحوكمة · المخاطر · الامتثال',
      ...
      trustedBy: 'خبرة استشارية في الشرق الأوسط وأمريكا الشمالية',
