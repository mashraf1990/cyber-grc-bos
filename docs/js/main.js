...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const i18n = {
    en: {
      home: 'Home', about: 'About', services: 'Services', industries: 'Industries',
      ...
      snb: 'Saudi National Bank', diriyah: 'Diriyah Project', nvits: 'NVITS (USA)', parentApp: 'Parent.app', healthcare: 'Healthcare SaaS',
    ...
    ar: {
      editMode: 'تعديل',
      home: 'الرئيسية', about: 'عني', services: 'الخدمات', industries: 'الصناعات',
      ...
      snb: 'البنك الأهلي السعودي', diriyah: 'مشروع الدرعية', nvits: 'NVITS (أمريكا)', parentApp: 'Parent.app', healthcare: 'الرعاية الصحية',
